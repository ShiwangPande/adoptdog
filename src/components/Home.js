    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="relative bg-white p-6 rounded-md shadow-lg max-w-md w-full">
                ...
                <img src={`https://apdoptdogserver.onrender.com${dog.pic}`} alt={dog.name} className="w-full h-64 object-cover rounded-md mb-4" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {dogs.map(dog => (
                        <div key={dog.id} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                            <img src={`https://apdoptdogserver.onrender.com${dog.pic}`} alt={dog.name} className="w-full h-64 object-cover rounded-t-lg" />
                            <div className="mt-4">
